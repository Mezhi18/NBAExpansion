...
ggplot(scoring_data, aes(x = Year_Modified, fill = factor(Year_Modified))) +
...
data_1980_onwards <- scoring_data %>%
  filter(Year_Modified >= 1980)

# Create histogram for count of records per year from 1980 onwards
ggplot(data_1980_onwards, aes(x = Year_Modified)) +
  geom_histogram(stat = "count", bins = length(unique(data_1980_onwards$Year_Modified)), fill = "blue", color = "black") +
...
data_1980_60pts_plus <- scoring_data %>%
  filter(Year_Modified >= 1980, PTS >= 60)

# Create histogram for count of records per year for scores of 60 or more from 1980 onwards
ggplot(data_1980_60pts_plus, aes(x = Year_Modified)) +
  geom_histogram(stat = "count", bins = length(unique(data_1980_60pts_plus$Year_Modified)), fill = "red", color = "black") +
